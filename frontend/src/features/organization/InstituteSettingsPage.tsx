 ...
 * happened to live here originally. Users & roles and Role matrix moved
 * out too, into their own top-level "User" nav item (see
 * UserManagementPage) — user/role administration isn't institute
 * configuration either. What's left: the institution's own identity, its
 * org structure (schools/departments/programs), and the audit log. */
export function InstituteSettingsPage() {
  ...
  return (
    <RequirePermission anyOf={['org.view', 'program.view', 'institution.view', 'audit.view']}>
      <PageHeader
        title="Institute Settings"
        description="Institution identity, campuses, schools, departments, and programs."
      />
      {tabs.length === 0 ? (
